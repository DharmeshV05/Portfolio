const Contact = () => {
  return (
    <>
      <div  data-aos = "fade-up" data-aos-delay="1000" className="px-5 max-w-[1080px] mx-auto mt-20 py-10">
        {/* top */}
        <div className="">
          {/* header */}
          <div className=" mb-10">
            ...
            <div className="border border-[#ABB2BF] p-4">
              ...
              <div className="">
                ...
                <div className="flex gap-1 items-center">
                  ...
                  <span className="text-[#ABB2BF]">!Dharmesh#3519</span>
                </div>
                <div className="flex gap-1 items-center">
                  <img src={require("./imgs/Email.png")} alt="" />
                  <span className="text-[#ABB2BF]">Dharmesh@Dharmesh.me</span>
                </div>
              </div>
            </div>
          </div>
