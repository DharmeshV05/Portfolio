    ...
    <>
      <div data-aos="fade-up" data-aos-delay="300" className="border mx-auto w-[90%] md:w-[48%] lg:w-[30%] border-[#ABB2BF] p-0">
        ...
        <div className="p-4">
          ...
          {/* btns */}
          <div className="">
            <a href={"https://react-eshop-lovat.vercel.app/#/"} target="_blank" rel="noopener noreferrer" className="py-2 px-4 text-white border border-[#C778DD] hover:bg-[#C778DD33] duration-150">
              Live {"<"}~{">"}
            </a>
          </div>
        </div>
